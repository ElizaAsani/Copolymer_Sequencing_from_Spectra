...
def stratified_split_indices(sequence_lengths, train_frac=0.7, val_frac=0.15, test_frac=0.15, seed=42):
    """
...
def make_splits(dataset, train_frac=0.7, val_frac=0.15, test_frac=0.15, seed=42):
